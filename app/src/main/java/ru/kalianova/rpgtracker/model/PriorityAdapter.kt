...
class PriorityAdapter(context: Context, list: List<Priority>)
    : ArrayAdapter<Priority>(context, 0, list){
    ...
    private fun view(view: View, position: Int): View {
        ...
        val item: Priority = getItem(position) ?: return view
    ...
    private var filter: Filter = object : Filter(){
        override fun convertResultToString(resultValue: Any?): CharSequence {
            val str = (resultValue as Priority).name
            return str
        }
