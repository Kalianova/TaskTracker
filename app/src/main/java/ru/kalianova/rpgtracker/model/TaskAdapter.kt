...
class TaskAdapter(context: Context, list: List<Task>)
    : ArrayAdapter<Task>(context, 0, list){
    ...
    private fun view(view: View, position: Int): View {
        ...
        val item: Task = getItem(position) ?: return view
    ...
    private var filter: Filter = object : Filter(){
        override fun convertResultToString(resultValue: Any?): CharSequence {
            val str = (resultValue as Task).name
            return str
        }
